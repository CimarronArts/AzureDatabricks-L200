...
# MAGIC %fs ls dbfs:/user/hive/warehouse/scott_smith_ap_juice_db.db/stores/_delta_log/

# COMMAND ----------

# MAGIC %fs head dbfs:/user/hive/warehouse/scott_smith_ap_juice_db.db/stores/_delta_log/00000000000000000000.json
...
# MAGIC 
# MAGIC create table stores_clone DEEP CLONE stores VERSION AS OF 5 -- you can specify timestamp here instead of a version
...
# MAGIC %fs ls /user/hive/warehouse/scott_smith_ap_juice_db.db/stores_clone/_delta_log/
...
# MAGIC %sql
# MAGIC select * from stores_clone
# MAGIC --We had removed the BNE02 id and updated the 
...
# MAGIC %sql
# MAGIC select * from stores_clone_shallow

# COMMAND ----------

# MAGIC %fs ls /user/hive/warehouse/scott_smith_ap_juice_db.db/stores_clone_shallow

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO stores_clone_shallow values ('SH01', 'Shallow', '', '', '', '', '')

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO stores values ('SH02', 'New', '', '', '', '', '')
...
# MAGIC %sql
# MAGIC select * from stores_clone_shallow where id = "SH01"
